...
```{r,fig.cap="Mapa das Mesorregiões do Estado de Goiás segundo o IBGE."}
source(file = "MapaMesorregiões.R")
MapaMeso
```
...
source(file = "MapaRegiõesPlanejamento.R")
MapaSEGPLAN
```
...
```{r,fig.cap="Mapa das Mesorregiões do Estado de Goiás segundo o IBGE."}
source(file = "MapaMicrorregiãoRPSEGPLAN.R")
grafico
```
