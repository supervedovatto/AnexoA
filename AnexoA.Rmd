...
```{r,fig.cap=paste("Número de postos de trabalho nos subsetores do setor de serviços em Goiás, na Região de Planejamento",LocRef$RPSEGPLAN,"e no município de",LocRef$Localidade,"nos últimos anos."),fig.asp = 1.618}
