...
tabela <- EmpregoCAGED %>% 
  ...
  kable(caption = paste("Saldo acumulado da geração de empregos por setor entre",max(EmpregoCAGED$Ano)-5,"e",max(EmpregoCAGED$Ano),"na Região de Planejamento",LocRef$RPSEGPLAN,"segundo a CAGED"))